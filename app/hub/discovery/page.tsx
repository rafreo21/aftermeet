      ...
      <section className="discovery-section" id="interview-guide">
        ...
        <div className="guide-layout">
          ...
          <aside><h3>Interviewer warnings</h3><ul>
            <li>Do not pitch AfterMeet at the beginning.</li><li>Do not ask “Would you use this?”</li><li>Do not ask leading questions.</li><li>Ask for recent, specific examples.</li><li>Separate stated preference from demonstrated behaviour.</li><li>Ask permission before recording.</li><li>Never paste highly sensitive or unnecessary personal information.</li>
          </ul></aside>
        </div>
      </section>
