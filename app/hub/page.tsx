...
const phases: Phase[] = [
  {
    ...
    items: [
      ...
      { id: "brand", title: "Decide whether AfterMeet remains the working name", detail: "Check domains and trademarks only after the concept survives validation.", priority: "Later" },
    ],
  },
  {
    id: "discovery",
...
const evidenceById: Partial<Record<string, EvidenceRecord>> = {
  ...
  contacts: { text: "Local contact creation, search, and meeting context exist. Repeated Encounters and a contact timeline are unsupported.", link: "/app/contacts", lastUpdated: currentDate },
  notes: { text: "Typed private meeting context is available in local contact capture. Voice capture and transcription are not implemented.", link: "/app/contacts/new", lastUpdated: currentDate },
  ...
  return (
    <main className="hub-shell">
                  ...
                  {phase.id === "foundation" && (
                    <section className="foundation-summary" aria-labelledby="foundation-summary-title">
                      <div className="foundation-summary-head">
                        ...
                        <h4 id="foundation-summary-title">Who AfterMeet is for—and the outcome it owns.</h4>
                      </div>
                      <dl>
      ...
      <footer className="hub-footer">
        <div><span className="hub-brand-mark">A</span><strong>AfterMeet MVP hub</strong></div>
