...
export default function ContactDetailPage() {
  ...
  if (!contact) {
    return (
      <AppShell active="contacts" title="Contact" actions={<LinkButton size="small" variant="ghost" href="/app/contacts"><ArrowLeftIcon size={16} />People</LinkButton>}>
        <div className="empty-state"><div><h2>Person not found</h2><p>This contact may have been removed or saved in another browser.</p><LinkButton href="/app/contacts">Back to People</LinkButton></div></div>
      </AppShell>
    );
  }
  ...
  return (
    <AppShell
      ...
      actions={<LinkButton size="small" variant="ghost" href="/app/contacts"><ArrowLeftIcon size={16} />People</LinkButton>}
    >
