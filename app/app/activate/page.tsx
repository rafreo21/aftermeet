...
export default function ActivatePage() {
  ...
  return (
    <AppShell
      active="activate"
      title="Activate data"
      subtitle="Move relationship context into your CRM when you are ready — nothing leaves AfterMeet automatically."
    >
      <div className="flow-page activate-page">
        <div className="flow-heading">
          <div>
            <h1>Turn conversations into CRM records.</h1>
            <p>Review-first sync keeps you in control. Tag campaigns to see attribution, then move records into HubSpot when ready.</p>
          </div>
        </div>
        ...
        <section className="activate-panel">
          ...
          <div className="activate-actions">
            ...
            <LinkButton variant="secondary" href="/app/contacts">Review contacts</LinkButton>
          </div>
        ...
        <section className="activate-panel">
          ...
          <div className="activate-actions">
            <LinkButton href="/app/activate/campaigns"><ChartLineUpIcon size={18} weight="bold" />Open campaigns</LinkButton>
            <LinkButton variant="secondary" href="/app/activate/campaigns/new">Create campaign</LinkButton>
          </div>
        </section>
        ...
        <section className="activate-panel">
          ...
          <div className="activate-actions">
            <LinkButton href="/app/outbound"><PaperPlaneTiltIcon size={18} weight="bold" />Open outbound queue</LinkButton>
